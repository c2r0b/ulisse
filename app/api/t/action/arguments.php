...
switch(($_DATA = get_post_data())['cmd']) {
	// Add a new argument ________________________________________________________
	case 'add':
	...
	// Edit an already exsisting argument ________________________________________
	case 'edit':
	...
	// Delete an already exsisting argument ______________________________________
	case 'remove':
		execute("
			DELETE FROM
				argument
